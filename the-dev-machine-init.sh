...
install "The Dev Machine". It just does platform detection, downloads the
configuration files, scripts, and runs it.
...
usage() {
    cat <<EOF
the-dev-machine-init.sh 0.0.1

The Dev Machine Setup

Usage: the-dev-machine-init.sh [OPTIONS]
